  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        ...
        <CardDescription>Test Google authentication with Firebase</CardDescription>
      </CardHeader>
        ...
        {user ? (
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground text-center">
              This will create a user document in Firestore and set up Firebase authentication
            </p>
